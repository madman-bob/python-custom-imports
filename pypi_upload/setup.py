...
def get_version():
    init_contents = (project_root / "custom_imports/__init__.py").read_text(
        encoding="utf-8"
    )
...
setup(
    name="custom_imports",
    version=get_version(),
    packages=find_packages(include=("custom_imports", "custom_imports.*")),
    install_requires=get_requirements(),
    setup_requires=["wheel"],
    author="Robert Wright",
    author_email="madman.bob@hotmail.co.uk",
    description="Tools to hook into Python's import syntax",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/madman-bob/python-custom-imports",
    license="MIT",
    classifiers=[
